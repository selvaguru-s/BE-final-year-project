  ...
  class TwitterClient(object): 
    def __init__(self): 
        ...
        try: 
            ...
            auth = OAuthHandler('qhwg88DbtCpCG2hQumqSKj3qp', 'BZy237443Jj7hePJvSnRUFMePKCnrXVtEbhzXYQbDEwtUm8LQy') 
            # set access token and secret 
            auth.set_access_token('3315982002-w8V3IgrJWXKjNHuKjqMWOj7dGsTqG2rZaQSl91Y', 'LBkNkwRhZga9O3MokOIClPagFWGBx97DDo6RXvWFwqjrv') 
